...
public class DailySummaryBusiness(IMyRepository repo) : IDailySummaryBusiness
{
    ...
    public Task<List<StormEventsDailySummaryEntity>> GetMissingPostersByYear(int year, CancellationToken ct)
    {
